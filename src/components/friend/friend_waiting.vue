    ...
    <div class="wt_container">
        <div  class="wt_container_nx">
            <div v-if="ok" class="wt_container_in">
                <div class="wt_cantainer_list_item_head">待处理数-{{count}}</div>
                <div class="wt_cantainer_list_item" v-for="i in count" v-bind:key='i.id'>
                    <div class="wt_cantainer_list_item_info">
                        ...
                        <div class="wt_cantainer_list_item_name">
                            <div class="wt_cantainer_list_item_name_1">nxo<span>#1234</span></div>
                            <div>收到的好友请求</div>
                        </div>
                    </div>
                    <div class="wt_cantainer_list_item_action">
                        ...
                        <div class="wt_cantainer_list_item_action_com wt_cantainer_list_item_action_access">
...
.wt_cantainer_list_item_img img{
    width: 32px;
    height: 32px;
    border-radius: 50px;
}
