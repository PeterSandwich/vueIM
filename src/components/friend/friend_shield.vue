    ...
    <div class="sh_container">
        <div  class="sh_container_nx">
            <div v-if="ok" class="sh_container_in">
                <div class="sh_cantainer_list_item_head">屏蔽好友数-{{count}}</div>
                <div class="sh_cantainer_list_item" v-for="i in count" v-bind:key='i.id'>
                    <div class="sh_cantainer_list_item_info">
                        ...
                        <div class="sh_cantainer_list_item_name">
                            <div class="sh_cantainer_list_item_name_1">nxo<span>#1234</span></div>
                            <div>收到的好友请求</div>
                        </div>
                    </div>
                    <div class="sh_cantainer_list_item_action">
                        ...
                        <div class="sh_cantainer_list_item_action_com sh_cantainer_list_item_action_access">
...
.sh_cantainer_list_item_img img{
    width: 32px;
    height: 32px;
    border-radius: 50px;
}
